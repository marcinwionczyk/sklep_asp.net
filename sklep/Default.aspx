...
<asp:Content ContentPlaceHolderID="NavigationContentPlaceHolder" ID="Content1" runat="server">
    ...
    <div class="loginform">
    <asp:Button ID="WyczyœæButton" runat="server" Text=" Wyczyœæ " 
        onclick="WyczyœæButton_Click" onmouseover="this.style.cursor='hand';" 
            CssClass="button"/>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
                                                ControlToValidate="UserName" ErrorMessage="Proszê podaæ login." 
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="RememberMe" runat="server" 
                                                Text="Zapamiêtaj mnie nastêpnym razem" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="right">
                                            ...
                                            <asp:Button ID="Button1" runat="server" CssClass="button" 
                                                Text="Zarejestruj siê" Width="104px" onclick="Button1_Click" />
                                        </td>
                                    </tr>
                                    <tr><td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TwoColumnContentPlaceHolder" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <p>
        Z³¹cza : D-Sub : GN DB 9 ¯EÑSKIE K¥TOWE DO DRUKU <br /> 
        Stara cena: 1,60 z³ <br />
        Nowa cena: 1,50 z³
        </p>
        </asp:View>
        <asp:View ID="NonLoggedDoKasyView" runat="server">
        <p>Aby sfinalizowaæ zakup w sklepie <%=ConfigurationManager.AppSettings["NazwaFirmy"] %> nale¿y siê 
            <asp:Button ID="RejestracjaButton" runat="server" Text="zarejestrowaæ" 
                ...
                onmouseout="this.style.textDecoration = 'none';" /> lub <a href="#logowanie">zalogowaæ</a>.  Po zalogowaniu lub rejestracji, zostanie wyœwietlone podsumowanie zakupu. W podsumowaniu bêdzie mo¿liwy wybór: sposobu p³atnoœci, rezygnacji z zakupu lub jego zatwierdzenia. </p>
                <p>W razie jakichkolwiek pytañ lub w¹tpliwoœci proszê siê kontaktowaæ z nami telefonicznie (tel. <%=ConfigurationManager.AppSettings["TelefonDoFirmy"] %>)</p>
        </asp:View>
        <asp:View ID="FinalizeShoppingView" runat="server">
    <div class="column1-unit">
    <div class="tabelka">
        <asp:Table ID="koszykszczegó³owy" runat="server" BorderStyle="Solid" 
            ...
            <WizardSteps>
                ...
                <td align="right">Imiê: </td><td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ...
                        ValidationExpression="[a-zA-Z¥ÆÊ£ÑŒÓ¯¹æê³œñóŸ¿]+" ValidationGroup="CUWnext">Imiê sk³ada siê wy³¹cznie z liter</asp:RegularExpressionValidator>
                    </td>
                </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" 
                                ...
                                ValidationExpression="[a-zA-Z¥ÆÊŒ£ÑÓ¯¹æê³ñœóŸ¿]+" ValidationGroup="CUWnext">Nazwisko sk³ada siê tylko z liter</asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator10" 
                                ...
                                ValidationGroup="CUWnext">tylko litery, cyfry, oraz znaki: myœlnik, kropka, przecinek, spacja, ukoœnik</asp:RegularExpressionValidator>
                            <br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                                ...
                                ValidationExpression="[a-zA-Z¥ÆŒÊ£ÑÓ¯¹æê³ñœóŸ¿. ]+" ValidationGroup="CUWnext">Nazwa miejscowoœci sk³ada siê tylko z liter</asp:RegularExpressionValidator>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
                                ...
                                ValidationExpression="(\(\d{2}\)\d{7}|\d{9})" ValidationGroup="CUWnext">nieprawid³owy numer telefonu (format numeru (AA)BBBBBBB lub BBBBBBBBB (komórka), AA - nr kierunkowy, B - pozosta³e cyfry)</asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
